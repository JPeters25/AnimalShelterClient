...
namespace AnimalShelterClient.Controllers
{
  public class AnimalsController : Controller
  {
    ...
    {
      var animalSpecies = Animal.GetSpecies(species);
      return View(animalSpecies);
    }

    [HttpPost]
    public IActionResult Species(Animal animal)
    {
      Animal.Post(animal);
      return RedirectToAction("Index");
    }
    ...
    {
      var animalGender = Animal.GetGender(gender);
      return View(animalGender);
    }

    [HttpPost]
    public IActionResult Gender(Animal animal)
    {
      Animal.Post(animal);
      return RedirectToAction("Index");
    }
